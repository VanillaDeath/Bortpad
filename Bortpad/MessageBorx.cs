...
namespace Bortpad
{
    ...
    {
        private static MessageBorx _thisMessageBorx;
        ...
        private MessageBorx(string message, string subMessage, string caption, MessageBoxIcon icon, List<Button> buttons, string defaultButton)
        {
            InitializeComponent();
            SetMessage(message);
            SetCaption(caption);
        ...
        // Buttons should at least have Text and DialogResult properties, TabIndex optionally, and Name if setting as defaultButton
        ...
        {
            _thisMessageBorx = new(message, subMessage, caption, icon, buttons, defaultButton);
            return _thisMessageBorx.ShowDialog();
        }

        public new static DialogResult Show()
        {
            return Show(null, null, null, MessageBoxIcon.None, null, null);
        }
